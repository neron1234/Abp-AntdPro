...
namespace TuDou.Grace.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : GraceAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<GraceDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(GraceConsts.ConnectionStringName).Value.ToString();
        }
