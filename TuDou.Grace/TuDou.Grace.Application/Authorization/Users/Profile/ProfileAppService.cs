...
using TuDou.Grace.Authentication.TwoFactor.Google;
using TuDou.Grace.Authorization.Users.Dto;
using TuDou.Grace.Authorization.Users.Profile.Cache;
using TuDou.Grace.Authorization.Users.Profile.Dto;
using TuDou.Grace.Friendships;
using TuDou.Grace.Gdpr;
using TuDou.Grace.Identity;
using TuDou.Grace.Net.Sms;
using TuDou.Grace.Security;
using TuDou.Grace.Storage;
using TuDou.Grace.Timing;

namespace TuDou.Grace.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : GraceAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("TuDou.Grace",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("TuDou.Grace",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
