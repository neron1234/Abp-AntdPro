...
namespace TuDou.Grace.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : GraceServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TuDou.Grace", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
